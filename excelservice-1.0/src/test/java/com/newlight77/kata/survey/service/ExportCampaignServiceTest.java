...
import com.newlight77.kata.survey.service.utils.ExportCompaignUtilsImpl;
...
public class ExportCampaignServiceTest {
    ...
    private ExportCompaignUtils exportCompaignUtils;
   
	
    @Mock
    private ExportCompaignService mailServiceMock;

	@Mock
	private JavaMailSender mailSenderMock;
	@Mock
	private MailServiceConfig mailServiceConfigMock; 
    ...
    public void init() {
        ...
        exportCompaignUtilsImpl = new ExportCompaignUtilsImpl( mailSenderMock , mailServiceConfigMock);
        //service = new CampaignServiceImpl(campaignClientMock, mailServiceMock);
